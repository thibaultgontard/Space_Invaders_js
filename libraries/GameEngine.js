...
class ScoreManager {
    constructor() {
        ...
        this.image = gTextures["coeur"]
        let bestscore1 = localStorage.getItem(score1)
        if(bestscore1 == null)
        {
           this.bestscore = 0
        }
        ...
        {
            this.bestscore = parseInt(bestscore1)
        }
    }
    ...
    incrementsPoints(amt) {
        ...
        if(this.points >this.bestscore)
        {
            ...
            localStorage.setItem(score1,this.bestscore)
        }
    }
    ...
    render() {
        ...
        this.label.render(380, 30)

        fill(255, 50, 50, 200)
        strokeWeight(0)
        let xd = CANVAS_WIDTH - 300

        if (this.lives > 0) {
            for (let i = 0; i < this.lives; i++) {
                //ellipse(xd + 25 * i, 30, 20)
                image(this.image,xd + 30 * i,10)
            }
        }
    }
}
